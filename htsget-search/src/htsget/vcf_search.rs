...
// use noodles_vcf::{AsyncReader, Reader};
// use noodles::tabix;
...
// };
//
// pub(crate) struct VcfSearch<S, R> {
//   storage: Arc<S>,
...
// #[async_trait]
// impl<'a, S, R>
//   BgzfSearch<'a, S, R, ReferenceSequence, tabix::Index, vcf::Reader<bgzf::Reader<File>>, Header>
//   for VcfSearch<S, R>
// where
...
// #[async_trait]
// impl<'a, S, R>
//   Search<'a, S, R, ReferenceSequence, tabix::Index, vcf::Reader<bgzf::Reader<File>>, Header>
//   for VcfSearch<S, R>
// where
//   S: AsyncStorage + Send + Sync + 'static,
//   R: AsyncRead + Send + Sync + Unpin
// {
//   fn reader_fn(file: File) -> Reader<bgzf::Reader<File>> {
//     todo!()
//   }
//
