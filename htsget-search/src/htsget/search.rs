  ...
  Index: Send + Sync,
{
  ...
  async fn get_byte_ranges_for_all<K>(&self, key: K, index: &Index) -> Result<Vec<BytesRange>>;

  /// Returns the header bytes range.
  async fn get_byte_ranges_for_header<K>(&self, key: &K) -> Result<Vec<BytesRange>>;
}
  ...
  Index: Send + Sync,
{
  ...
  async fn get_byte_ranges_for_unmapped_reads<K>(
    &self,
    key: &K,
    index: &Index,
  ...
  async fn get_byte_ranges_for_reference_sequence<K>(
    &self,
    key: K,
  ...
  async fn get_byte_ranges_for_reference_name_reads<K>(
    &self,
    key: K,
    reference_name: &str,
    index: &Index,
  ...
  Self: Sync + Send,
{
  ...
  async fn read_index<K>(&self, key: &K) -> Result<Index> {
  ...
  async fn reader<K>(key: &K, storage: Arc<S>) -> Result<Reader> {
  ...
  async fn create_reader<K>(&self, key: &K) -> Result<(Reader, Header)> {
  ...
  Header: FromStr + Send,
{
  ...
  async fn get_byte_ranges_for_reference_sequence_bgzf<K>(
    &self,
    key: K,
  ...
  async fn get_byte_ranges_for_unmapped<K>(
    &self,
    _key: &K,
    _index: &Index,
  ) -> Result<Vec<BytesRange>> {
