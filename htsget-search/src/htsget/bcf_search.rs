...
// 
// #[async_trait]
// impl<'a, S, R> BgzfSearch<'a, S, R, ReferenceSequence, Index, bcf::Reader<File>, vcf::Header>
//   for BcfSearch<S, R>
// where
...
// 
// #[async_trait]
// impl<'a, S, R> Search<'a, S, R, ReferenceSequence, Index, bcf::Reader<File>, vcf::Header> for BcfSearch<S, R>
// where
//   S: AsyncStorage + Send + Sync + 'static,
//   R: Unpin + Send + Sync
// {
//   fn reader_fn(file: File) -> Reader<File> {
//     todo!()
//   }
// 
