...
fn criterion_benchmark(c: &mut Criterion) {
  ...
  bench_query(
    &mut group,
    "[LIGHT] Bam query all",
    Query::new_with_defaults("bam/htsnexus_test_NA12878", Bam),
  );
  bench_query(
    &mut group,
  ...
  bench_query(
    ...
    Query::new_with_defaults("bam/htsnexus_test_NA12878", Bam).with_class(Header),
  );

  bench_query(
    &mut group,
    "[LIGHT] Cram query all",
    Query::new_with_defaults("cram/htsnexus_test_NA12878", Cram),
  );
  bench_query(
    &mut group,
  ...
  bench_query(
    ...
    Query::new_with_defaults("cram/htsnexus_test_NA12878", Cram).with_class(Header),
  );

  bench_query(
    &mut group,
    "[LIGHT] Vcf query all",
    Query::new_with_defaults("vcf/sample1-bcbio-cancer", Vcf),
  );
  bench_query(
    &mut group,
  ...
  bench_query(
    ...
    Query::new_with_defaults("vcf/sample1-bcbio-cancer", Vcf).with_class(Header),
  );

  bench_query(
    &mut group,
    "[LIGHT] Bcf query all",
    Query::new_with_defaults("bcf/sample1-bcbio-cancer", Bcf),
  );
  bench_query(
    &mut group,
  ...
  bench_query(
    ...
    Query::new_with_defaults("bcf/sample1-bcbio-cancer", Bcf).with_class(Header),
  );
