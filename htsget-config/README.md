...
| <span id="endpoint_header">`endpoint_header`</span> | The URL to fetch underlying for a file. The request will be a GET request which expects to get the decrypted underlying header from a BAM/CRAM/VCF file.         | HTTP URL                 | `"https://127.0.0.1:8081/"`                                                                                     |
