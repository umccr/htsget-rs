...
// 
// #[async_trait]
// impl<'a, S, R> BgzfSearch<'a, S, R, ReferenceSequence, Index, Reader<AsyncReader<R>>, Header>
//   for BamSearch<S, R>
// where
...
// 
// #[async_trait]
// impl<'a, S, R> Search<'a, S, R, ReferenceSequence, bai::Index, bam::Reader<AsyncReader<R>>, sam::Header>
//   for BamSearch<S, R>
// where
//   S: AsyncStorage + Send + Sync + 'static,
//   R: AsyncRead + Unpin + Send + Sync + BlockPosition
// {
//   fn reader_fn(file: File) -> Reader<AsyncReader<R>> {
//     todo!()
//   }
// 
...
// 
// #[async_trait]
// impl<'a, S, R> SearchReads<'a, S, R, ReferenceSequence, bai::Index, Reader<AsyncReader<R>>, sam::Header>
//   for BamSearch<S, R>
//   where
//       S: AsyncStorage + Send + Sync + 'static,
//       R: AsyncRead + Unpin + Send + Sync + BlockPosition
